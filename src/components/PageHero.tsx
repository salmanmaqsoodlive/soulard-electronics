  ...
  return (
    <section className="relative pt-32 pb-20 overflow-hidden bg-navy">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <h1 className="font-display text-5xl md:text-7xl text-white uppercase tracking-wider mb-4">{title}</h1>
        {subtitle && <p className="text-gray-300 text-lg max-w-2xl leading-relaxed">{subtitle}</p>}
        {children}
      </div>
    </section>
  )
